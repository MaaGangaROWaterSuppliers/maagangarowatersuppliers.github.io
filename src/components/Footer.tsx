...
const Footer = () => {
  const quickLinks = ['Home', 'Services', 'Areas', 'Pricing', 'Contact'];
  const services = [
                ...
                {quickLinks.map((item) => (
                    <li key={item}>
                      <a
                          ...
                          className="text-blue-200 hover:text-white transition-colors block py-1"
                      >
                        {item}
                      </a>
                    </li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {services.map((service) => (
                    <li key={service}>
                      <span className="text-blue-200 block py-1">{service}</span>
                    </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <PhoneCall className="w-5 h-5 text-blue-300 mr-3 mt-0.5 flex-shrink-0" />
                  <a
                      href="tel:9990160746"
                ...
                <li className="flex items-start">
                  ...
                  <a
                      href="mailto:karamchandnagar33@gmail.com"
                ...
                <li className="flex items-start">
                  <MapPin className="w-5 h-5 text-blue-300 mr-3 mt-0.5 flex-shrink-0" />
